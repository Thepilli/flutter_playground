...
class RandomSelectionComponent extends StatefulWidget {
  const RandomSelectionComponent({super.key});

  @override
  _RandomSelectionComponentState createState() =>
      _RandomSelectionComponentState();
}

class _RandomSelectionComponentState extends State<RandomSelectionComponent> {
